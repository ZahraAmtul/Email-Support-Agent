...
EMAIL_AUTO_REPLY_THRESHOLD = 0.85  # Confidence threshold for auto-reply
MAX_EMAIL_PROCESSING_TIME = 300  # seconds
SENSITIVE_FIELDS = ['password', 'ssn', 'credit_card', 'card_number']
